    ...
    <div class="container mt-5">
        ...
        <form action="/Ferreteria/ServletPrincipal?accion=ModificarEmpleado" method="post"> <!-- Modify the action attribute with the appropriate Servlet URL -->
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" id="fechaNacimiento" name="fechaNacimiento" value="<c:out value="${param.fechaNacEmpleado}" />">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="idCargo" name="idCargo" value="<c:out value="${param.idCargo}" />">
            </div>
            <div class="form-group">
