...
<body>
    <div class="container mt-5">
        <h1 class="mb-4">Modificar Cliente <i class="fas fa-user-edit"></i></h1>
        
        <form action="/Ferreteria/ServletPrincipal?accion=ModificarCliente" method="post"> <!-- Actualiza la acción con la URL correcta del servlet -->
